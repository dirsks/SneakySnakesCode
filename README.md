...
# HOW TO RUN (Online Multiplayer):
  ...
  2. Open a terminal in the server/ folder:
       ...
       npm install
       node server.js
  4. Launch SneakySnakes, click "Online Mode"
  5. Enter your name and the server address (default: ws://localhost:3000)
  6. Share the address with friends on the same network!
